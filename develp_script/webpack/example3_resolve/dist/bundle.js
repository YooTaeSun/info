...
/* WEBPACK VAR INJECTION */(function($, jqueryObj) {// #1 - Using NPM
//var $ = require('jquery');
...
console.log("loaded jQuery version is 1 " + $.fn.jquery);
console.log("loaded jQuery version is 2 " + jqueryObj.fn.jquery);
